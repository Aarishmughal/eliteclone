...
<body>
                ...
                <div class="offcanvas-body">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item m-1 dropdown">
                            <a class="nav-link px-3 dropdown-toggle {{ request()->routeIs('projects', 'publications', 'topics') ? 'active' : '' }}"
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item" href="{{ Route('topics') }}">Research Topics</a></li>
                            </ul>
                        </li>
                        <li class="nav-item m-1">
                            <a class="nav-link px-3 {{ request()->routeIs('teaching') ? 'active' : '' }}"
                                href="{{ Route('teaching') }}">Teaching</a>
                        </li>
                        <li class="nav-item m-1 dropdown">
    ...
    <div class="wrapper d-flex flex-column min-vh-100">
        ...
        <div class="container">
            ...
            <p class="text-secondary text-center mb-4 form-text">Built with <a
