...
@section('content')
    <div class="container p-3">
        <h1 class="mb-4 border-bottom">Teaching Material</h1>
        <div class="row row-cols-1 row-cols-md-2 g-4">
            <div class="col">
                <a href="/teaching/abc" class="text-decoration-none p-0" title="Click to Get Details" data-bs-toggle="tooltip"
                    data-bs-placement="bottom" data-bs-custom-class="custom-tooltip">
                    <div class="card p-3 custom-person-card">
                        <h4>Course Title <i class="bi bi-file-earmark-text"></i></h4>
                        <p>
