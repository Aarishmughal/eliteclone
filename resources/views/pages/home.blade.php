            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="card bg-info-subtle border-0">
                        <h4 class="card-header p-3 text-info">Quick Links</h4>
                        <div class="card-body">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item border-info-subtle list-group-item-action list-group-item-info">
                                    <a href="#">People &rarr;</a>
                                </li>
                                <li class="list-group-item border-info-subtle list-group-item-action list-group-item-info">
                                    <a href="#">Research &rarr;</a>
                                </li>
                                <li class="list-group-item border-info-subtle list-group-item-action list-group-item-info">
                                    <a href="#">Teaching &rarr;</a>
                                </li>
                                <li class="list-group-item border-info-subtle list-group-item-action list-group-item-info">
                                    <a href="#">Thesis &rarr;</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="container py-4">
        <div class="row gy-4">
            <div class="col-lg-4">
                <div class="card custom-home-card h-100 d-flex flex-column">
                    <div class="card-body d-flex flex-column">
                        <h1 class="fs-1"><i class="bi bi-book-half"></i></h1>
                        ...
                        <a href="#" class="btn btn-light mt-auto">Read More &rarr;</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="card custom-home-card h-100 d-flex flex-column">
                    <div class="card-body d-flex flex-column">
                        <h1 class="fs-1"><i class="bi bi-rocket-takeoff"></i></h1>
                        <a href="#" class="text-decoration-none">
            ...
            <div class="col-lg-4">
                <div class="card custom-home-card h-100 d-flex flex-column">
                    <div class="card-body d-flex flex-column">
                        <h1 class="fs-1"><i class="bi bi-lightbulb"></i></h1>
                        <a href="#" class="text-decoration-none">
