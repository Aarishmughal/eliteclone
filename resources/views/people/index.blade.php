...
<body>
    <!-- Main Content -->
    <div class="row p-2 d-flex justify-content-center align-items-center vh-100 top-margin">
                    ...
                    <div class="card custom-person-card rounded-4">
                        ...
                        <div class="card-footer d-flex gap-3">
                            <a href="{{ route('people.viewEdit', $user->id) }}"
                                ...
                                data-bs-placement="top" data-bs-title="Edit" data-bs-custom-class="custom-tooltip"><i
                            ...
                            <button href="#" class="btn btn-dark flex-grow-1 rounded-4" data-bs-toggle="tooltip"
                                data-bs-placement="top" data-bs-title="Administrator"
